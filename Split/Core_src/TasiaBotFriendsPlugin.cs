...
//  MAIN PLUGIN
// ═══════════════════════════════════════════════════════════
public sealed class TasiaBotFriendsPlugin : MonoBehaviour
{
    ...
    internal static BaseUnityPlugin Loader { get; set; }
    internal static ManualLogSource LogRef { get; set; }
    internal static ManualLogSource Log => LogRef;
    internal new ConfigFile Config => Loader?.Config;
